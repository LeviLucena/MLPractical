...
class PDFReport(FPDF):
    def header(self):
        ...
        self.cell(0, 10, 'Report: Genetic Syndrome Classification', 0, new_x='LMARGIN', new_y='NEXT', align='C')
        self.ln(5)
...
def create_report():
    ...
    # Methodology
    pdf.set_font('helvetica', 'B', 12)
    pdf.cell(0, 10, '2. Methodology', 0, new_x='LMARGIN', new_y='NEXT')
    pdf.set_font('helvetica', '', 10)
    pdf.multi_cell(0, 10,
    ...
    # Results
    pdf.set_font('helvetica', 'B', 12)
    pdf.cell(0, 10, '3. Results', 0, new_x='LMARGIN', new_y='NEXT')
    pdf.set_font('helvetica', '', 10)
    pdf.multi_cell(0, 10,
    ...
    pdf.set_font('helvetica', 'B', 12)
    pdf.cell(0, 10, '4. Analysis and Interpretation', 0, new_x='LMARGIN', new_y='NEXT')
    pdf.set_font('helvetica', '', 10)
    pdf.multi_cell(0, 10,
    ...
    pdf.set_font('helvetica', 'B', 12)
    pdf.cell(0, 10, '5. Challenges and Solutions', 0, new_x='LMARGIN', new_y='NEXT')
    pdf.set_font('helvetica', '', 10)
    pdf.multi_cell(0, 10,
        'Challenges:\\n'
    ...
    # Recommendations
    pdf.set_font('helvetica', 'B', 12)
    pdf.cell(0, 10, '6. Recommendations for Improvements', 0, new_x='LMARGIN', new_y='NEXT')
    pdf.set_font('helvetica', '', 10)
    pdf.multi_cell(0, 10,
